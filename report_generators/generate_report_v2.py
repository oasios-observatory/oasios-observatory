...
def load_scenarios() -> pd.DataFrame:
    ...
    # Focusing only on ev_scenarios as requested
    query = "SELECT id, params, narrative, signals FROM ev_scenarios WHERE params IS NOT NULL"
    try:
...
# ----------------------------------------------------------------------
# FINAL PAGE INFO BLOCK (Updated and Fixed for v12.2)
# ----------------------------------------------------------------------
