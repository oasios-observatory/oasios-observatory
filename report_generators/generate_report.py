...
"""
OASIOS OBSERVATORY – ASI Scenario Report Generator v12.3 (Trend Assessment Added)
...
def build_project_info_page(styles):
    ...
    content += [
        ...
        Paragraph(
            "Bukhtoyarov, M. (2025). <i>OASIOS Observatory: Open Artificial Superintelligence Scenario Modeling Platform (v0.3)</i>. "
            "GitHub Repository.",
            styles["Normal"]
        ),
        Paragraph(
